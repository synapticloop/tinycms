 ...
 * 
 * <p>Table name: <code>data_collection</code></p>
 * 
 * 
 ...
 */
public class DataCollectionQuestion {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DataCollectionQuestion.class);


	// this is an internal SQL question select statement used by the validator
	private static final String SQL_INTERNAL_DOES_PRIMARY_KEY_EXIST = "SELECT (COUNT(*) = 1) WHERE id_data_collection = ?";



	/** Private to deter instantiation */
	private DataCollectionQuestion() {}

	/**
	 * An internal method to check whether a specific primary key exists, 
	 * generated as part of the validation methods
	 * 
	 * @param idDataCollection The primary key for this model
	 * 
	 * @return whether the primary key exists
	 */
	public static boolean internalDoesPrimaryKeyExist(Long idDataCollection) {
