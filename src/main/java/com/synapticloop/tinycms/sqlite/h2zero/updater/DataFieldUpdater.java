...
public class DataFieldUpdater {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DataFieldUpdater.class);

	// static fields generated by synapticloop h2zero
	private static final String SQL_UPDATE_START = "update data_field ";
