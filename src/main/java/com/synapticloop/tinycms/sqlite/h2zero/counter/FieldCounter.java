...
public class FieldCounter {
	...
	private static final String BINDER = Constants.FIELD_BINDER;
		...
		private static final Logger LOGGER = LoggerFactory.getLogger(FieldCounter.class);


	private static final String SQL_BUILTIN_COUNT_ALL = "select count(*) from field";
	...
	/**
	 * Find the count of all Field objects and if there is an error
