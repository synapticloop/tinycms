...
public class CollectionFinder {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CollectionFinder.class);
	private static final String SQL_SELECT_START = 
		"""
			...
			from 
				collection
		""";
	private static final String SQL_BUILTIN_FIND_BY_PRIMARY_KEY = SQL_SELECT_START + " where id_collection = ?";
	 ...
	 * @param idCollection the primary key
	 * 
	 ...
	 */
	public static Collection findByPrimaryKey(Connection connection, Long idCollection) throws H2ZeroFinderException {
		Collection collection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;

		if(null == idCollection) {
			throw new H2ZeroFinderException("Could not find result as the primary key field [idCollection] was null.");
		}
		...
		try {
			...
			collection = uniqueResult(resultSet);
		} catch (H2ZeroFinderException | SQLException ex) {
			throw new H2ZeroFinderException(ex.getMessage() + "  Additionally, the parameters were [idCollection:" + idCollection + "].");
		} finally {
			ConnectionManager.closeAll(resultSet, preparedStatement);
		}

		if(null == collection) {
			throw new H2ZeroFinderException("Could not find result the parameters were [idCollection:" + idCollection + "].");
		}
		return(collection);
	}
	 ...
	 * @throws H2ZeroFinderException if one couldn't be found
	 */
	public static Collection findByPrimaryKey(Long idCollection) throws H2ZeroFinderException {
		...
		try (Connection connection = ConnectionManager.getConnection()) {
			collection = findByPrimaryKey(connection, idCollection);
	...
	/**
	 * Find a Collection by its primary key and silently fail.
	 ...
	 * 
	 */
	public static Collection findByPrimaryKeySilent(Connection connection, Long idCollection) {
		try {
			return(findByPrimaryKey(connection, idCollection));
		} catch(H2ZeroFinderException h2zfex){
			if(LOGGER.isWarnEnabled()) {
				LOGGER.warn("H2ZeroFinderException findByPrimaryKeySilent(" + idCollection + "): " + h2zfex.getMessage());
	 ...
	 * 
	 */
	public static Collection findByPrimaryKeySilent(Long idCollection) {
		try {
			return(findByPrimaryKey(idCollection));
		} catch(H2ZeroFinderException h2zfex){
			if(LOGGER.isWarnEnabled()) {
				LOGGER.warn("H2ZeroFinderException findByPrimaryKeySilent(" + idCollection + "): " + h2zfex.getMessage());
				if(LOGGER.isDebugEnabled()) {
	 ...
	 * 
	 * @return a list of all the Collection objects
	 * 
	 * @throws SQLException if there was an error in the SQL statement
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<Collection> findAll(Connection connection, Integer limit, Integer offset) throws SQLException, H2ZeroFinderException {
	...
	/**
	 * Find all the Collection objects - in effect this chains 
	 * to the findAll(connection, limit, offset) with null parameters.
	 * 
	 * @return The list of Collection model objects
	 * 
	 * @throws SQLException if there was an error in the SQL statement
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<Collection> findAll() throws SQLException, H2ZeroFinderException {
	 ...
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<Collection> findAll(Connection connection) throws SQLException, H2ZeroFinderException {
	 ...
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<Collection> findAll(Integer limit, Integer offset) throws SQLException, H2ZeroFinderException {
	 ...
	 * @param offset - the offset from the start of the results
	 * 
	 * @return The list of Collection model objects, or an empty List on error
	 */
	public static List<Collection> findAllSilent(Connection connection, Integer limit, Integer offset) {
		try {
	 ...
	 * @return The list of Collection model objects, or an empty List on error
	 */
	public static List<Collection> findAllSilent(Connection connection) {
	 ...
	 * @return The list of Collection model objects, or an empty List on error
	 */
	public static List<Collection> findAllSilent(Integer limit, Integer offset) {
	 ...
	 * @return The list of Collection model objects, or an empty List on error
	 */
	public static List<Collection> findAllSilent() {
	 ...
	 * key.
	 * 
	 * There are 0 defined finders on the collection table, of those finders
	 ...
	 * 
	 * @return The Collection that represents this result
	 * 
	 * @throws H2ZeroFinderException if no results were found or more than one result was found
	 * @throws SQLException if there was a problem retrieving the results
	 */
	private static Collection uniqueResult(ResultSet resultSet) throws H2ZeroFinderException, SQLException {
		if(resultSet.next()) {
			// we have a result
			Long idCollection = ConnectionManager.getNullableResultLong(resultSet, 1);
			String nmCollection = ConnectionManager.getNullableResultString(resultSet, 2);

			Collection collection = new Collection(idCollection, nmCollection);
	...
	/**
	 * Return the results as a list of Collection, this will be empty if
	 * none are found.
	 * 
	 * @param resultSet the results as a list of Collection
	 * 
	 * @return the list of results
	 * 
	 * @throws SQLException if there was a problem retrieving the results
	 */
	private static List<Collection> list(ResultSet resultSet) throws SQLException {
		List<Collection> arrayList = new ArrayList<Collection>();
