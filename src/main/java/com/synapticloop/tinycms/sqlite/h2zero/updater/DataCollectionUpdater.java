...
public class DataCollectionUpdater {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DataCollectionUpdater.class);

	// static fields generated by synapticloop h2zero
	private static final String SQL_UPDATE_START = "update data_collection ";

	// static fields generated from the user input

	private DataCollectionUpdater() {}
