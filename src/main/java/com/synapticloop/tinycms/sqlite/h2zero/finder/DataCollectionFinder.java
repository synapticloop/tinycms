...
public class DataCollectionFinder {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DataCollectionFinder.class);
	...
	private DataCollectionFinder() {}

	/**
	 * Find a DataCollection by its primary key
	 * 
	 * @param connection the connection item
	 * @param idDataCollection the primary key
	 * 
	 ...
	 */
	public static DataCollection findByPrimaryKey(Connection connection, Long idDataCollection) throws H2ZeroFinderException {
		DataCollection dataCollection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;

		if(null == idDataCollection) {
			throw new H2ZeroFinderException("Could not find result as the primary key field [idDataCollection] was null.");
		}
		...
		try {
			...
			dataCollection = uniqueResult(resultSet);
		} catch (H2ZeroFinderException | SQLException ex) {
			throw new H2ZeroFinderException(ex.getMessage() + "  Additionally, the parameters were [idDataCollection:" + idDataCollection + "].");
		} finally {
			ConnectionManager.closeAll(resultSet, preparedStatement);
		}

		if(null == dataCollection) {
			throw new H2ZeroFinderException("Could not find result the parameters were [idDataCollection:" + idDataCollection + "].");
		}
	 ...
	 * @throws H2ZeroFinderException if one couldn't be found
	 */
	public static DataCollection findByPrimaryKey(Long idDataCollection) throws H2ZeroFinderException {
		...
		try (Connection connection = ConnectionManager.getConnection()) {
			dataCollection = findByPrimaryKey(connection, idDataCollection);
	...
	/**
	 * Find a DataCollection by its primary key and silently fail.
	 ...
	 * 
	 */
	public static DataCollection findByPrimaryKeySilent(Connection connection, Long idDataCollection) {
		try {
			return(findByPrimaryKey(connection, idDataCollection));
		} catch(H2ZeroFinderException h2zfex){
			if(LOGGER.isWarnEnabled()) {
				LOGGER.warn("H2ZeroFinderException findByPrimaryKeySilent(" + idDataCollection + "): " + h2zfex.getMessage());
	 ...
	 * 
	 */
	public static DataCollection findByPrimaryKeySilent(Long idDataCollection) {
		try {
			return(findByPrimaryKey(idDataCollection));
		} catch(H2ZeroFinderException h2zfex){
			if(LOGGER.isWarnEnabled()) {
				LOGGER.warn("H2ZeroFinderException findByPrimaryKeySilent(" + idDataCollection + "): " + h2zfex.getMessage());
				if(LOGGER.isDebugEnabled()) {
	 ...
	 * 
	 * @return a list of all the DataCollection objects
	 * 
	 * @throws SQLException if there was an error in the SQL statement
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<DataCollection> findAll(Connection connection, Integer limit, Integer offset) throws SQLException, H2ZeroFinderException {
		...
		List<DataCollection> results = new ArrayList<DataCollection>();
	...
	/**
	 * Find all the DataCollection objects - in effect this chains 
	 * to the findAll(connection, limit, offset) with null parameters.
	 * 
	 * @return The list of DataCollection model objects
	 * 
	 * @throws SQLException if there was an error in the SQL statement
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<DataCollection> findAll() throws SQLException, H2ZeroFinderException {
	 ...
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<DataCollection> findAll(Connection connection) throws SQLException, H2ZeroFinderException {
	 ...
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<DataCollection> findAll(Integer limit, Integer offset) throws SQLException, H2ZeroFinderException {
	 ...
	 * @param offset - the offset from the start of the results
	 * 
	 * @return The list of DataCollection model objects, or an empty List on error
	 */
	public static List<DataCollection> findAllSilent(Connection connection, Integer limit, Integer offset) {
		try {
	 ...
	 * @return The list of DataCollection model objects, or an empty List on error
	 */
	public static List<DataCollection> findAllSilent(Connection connection) {
	 ...
	 * @return The list of DataCollection model objects, or an empty List on error
	 */
	public static List<DataCollection> findAllSilent(Integer limit, Integer offset) {
	 ...
	 * @return The list of DataCollection model objects, or an empty List on error
	 */
	public static List<DataCollection> findAllSilent() {
	 ...
	 * key.
	 * 
	 * There are 0 defined finders on the data_collection table, of those finders
	 ...
	 * 
	 * @return The DataCollection that represents this result
	 * 
	 * @throws H2ZeroFinderException if no results were found or more than one result was found
	 * @throws SQLException if there was a problem retrieving the results
	 */
	private static DataCollection uniqueResult(ResultSet resultSet) throws H2ZeroFinderException, SQLException {
		if(resultSet.next()) {
			// we have a result
			Long idDataCollection = ConnectionManager.getNullableResultLong(resultSet, 1);
			Long idCollection = ConnectionManager.getNullableResultLong(resultSet, 2);
			String nmCollection = ConnectionManager.getNullableResultString(resultSet, 3);
			Boolean flIsPublished = ConnectionManager.getNullableResultBoolean(resultSet, 4);

			DataCollection dataCollection = new DataCollection(idDataCollection, idCollection, nmCollection, flIsPublished);
	...
	/**
	 * Return the results as a list of DataCollection, this will be empty if
	 * none are found.
	 * 
	 * @param resultSet the results as a list of DataCollection
	 * 
	 * @return the list of results
	 * 
	 * @throws SQLException if there was a problem retrieving the results
	 */
	private static List<DataCollection> list(ResultSet resultSet) throws SQLException {
		List<DataCollection> arrayList = new ArrayList<DataCollection>();
		while(resultSet.next()) {
			arrayList.add(new DataCollection(
