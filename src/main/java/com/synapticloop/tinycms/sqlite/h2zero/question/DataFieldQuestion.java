 ...
 * 
 * <p>Table name: <code>data_field</code></p>
 * 
 * 
 ...
 */
public class DataFieldQuestion {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DataFieldQuestion.class);


	// this is an internal SQL question select statement used by the validator
	private static final String SQL_INTERNAL_DOES_PRIMARY_KEY_EXIST = "SELECT (COUNT(*) = 1) WHERE id_data_field = ?";



	/** Private to deter instantiation */
	private DataFieldQuestion() {}

	/**
	 * An internal method to check whether a specific primary key exists, 
	 * generated as part of the validation methods
	 * 
	 * @param idDataField The primary key for this model
	 * 
	 * @return whether the primary key exists
	 */
	public static boolean internalDoesPrimaryKeyExist(Long idDataField) {
