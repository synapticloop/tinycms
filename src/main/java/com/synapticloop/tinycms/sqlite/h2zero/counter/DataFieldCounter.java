...
public class DataFieldCounter {
	...
	private static final String BINDER = Constants.DATA_FIELD_BINDER;
		...
		private static final Logger LOGGER = LoggerFactory.getLogger(DataFieldCounter.class);


	private static final String SQL_BUILTIN_COUNT_ALL = "select count(*) from data_field";



	private DataFieldCounter() {}

	/**
	 * Find the count of all DataField objects
	 * 
	 * @param connection the passed in connection object, useful for queries within
	 * a transaction.
	 * 
	 * @return the count of DataField objects
	 * 
	...
	/**
	 * Find the count of all DataField objects and if there is an error
