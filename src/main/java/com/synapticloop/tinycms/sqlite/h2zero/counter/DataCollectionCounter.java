...
public class DataCollectionCounter {
	...
	private static final String BINDER = Constants.DATA_COLLECTION_BINDER;
		...
		private static final Logger LOGGER = LoggerFactory.getLogger(DataCollectionCounter.class);


	private static final String SQL_BUILTIN_COUNT_ALL = "select count(*) from data_collection";



	private DataCollectionCounter() {}

	/**
	 * Find the count of all DataCollection objects
	 * 
	 * @param connection the passed in connection object, useful for queries within
	 * a transaction.
	 * 
	 * @return the count of DataCollection objects
	 * 
	...
	/**
	 * Find the count of all DataCollection objects and if there is an error
