...
public class FieldFinder {
	...
	/**
	 * Find a Field by its primary key
	 * 
	 * @param connection the connection item
	 * @param idField the primary key
	 * 
	 ...
	 */
	public static Field findByPrimaryKey(Connection connection, Long idField) throws H2ZeroFinderException {
		Field field = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;

		if(null == idField) {
			throw new H2ZeroFinderException("Could not find result as the primary key field [idField] was null.");
		}
		...
		try {
			...
			field = uniqueResult(resultSet);
		} catch (H2ZeroFinderException | SQLException ex) {
			throw new H2ZeroFinderException(ex.getMessage() + "  Additionally, the parameters were [idField:" + idField + "].");
		} finally {
			ConnectionManager.closeAll(resultSet, preparedStatement);
		}

		if(null == field) {
			throw new H2ZeroFinderException("Could not find result the parameters were [idField:" + idField + "].");
		}
		return(field);
	}
	 ...
	 * @throws H2ZeroFinderException if one couldn't be found
	 */
	public static Field findByPrimaryKey(Long idField) throws H2ZeroFinderException {
		...
		try (Connection connection = ConnectionManager.getConnection()) {
			field = findByPrimaryKey(connection, idField);
	...
	/**
	 * Find a Field by its primary key and silently fail.
	 ...
	 * 
	 */
	public static Field findByPrimaryKeySilent(Connection connection, Long idField) {
		try {
			return(findByPrimaryKey(connection, idField));
		} catch(H2ZeroFinderException h2zfex){
			if(LOGGER.isWarnEnabled()) {
				LOGGER.warn("H2ZeroFinderException findByPrimaryKeySilent(" + idField + "): " + h2zfex.getMessage());
	 ...
	 * 
	 */
	public static Field findByPrimaryKeySilent(Long idField) {
		try {
			return(findByPrimaryKey(idField));
		} catch(H2ZeroFinderException h2zfex){
			if(LOGGER.isWarnEnabled()) {
				LOGGER.warn("H2ZeroFinderException findByPrimaryKeySilent(" + idField + "): " + h2zfex.getMessage());
				if(LOGGER.isDebugEnabled()) {
	 ...
	 * 
	 * @return a list of all the Field objects
	 * 
	 * @throws SQLException if there was an error in the SQL statement
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<Field> findAll(Connection connection, Integer limit, Integer offset) throws SQLException, H2ZeroFinderException {
	...
	/**
	 * Find all the Field objects - in effect this chains 
	 * to the findAll(connection, limit, offset) with null parameters.
	 * 
	 * @return The list of Field model objects
	 * 
	 * @throws SQLException if there was an error in the SQL statement
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<Field> findAll() throws SQLException, H2ZeroFinderException {
	 ...
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<Field> findAll(Connection connection) throws SQLException, H2ZeroFinderException {
	 ...
	 * @throws H2ZeroFinderException if no results were found
	 */
	public static List<Field> findAll(Integer limit, Integer offset) throws SQLException, H2ZeroFinderException {
	 ...
	 * @param offset - the offset from the start of the results
	 * 
	 * @return The list of Field model objects, or an empty List on error
	 */
	public static List<Field> findAllSilent(Connection connection, Integer limit, Integer offset) {
		try {
	 ...
	 * @return The list of Field model objects, or an empty List on error
	 */
	public static List<Field> findAllSilent(Connection connection) {
	 ...
	 * @return The list of Field model objects, or an empty List on error
	 */
	public static List<Field> findAllSilent(Integer limit, Integer offset) {
	 ...
	 * @return The list of Field model objects, or an empty List on error
	 */
	public static List<Field> findAllSilent() {
	 ...
	 * key.
	 * 
	 * There are 0 defined finders on the field table, of those finders
	 ...
	 * 
	 * @return The Field that represents this result
	 * 
	 * @throws H2ZeroFinderException if no results were found or more than one result was found
	 * @throws SQLException if there was a problem retrieving the results
	 */
	private static Field uniqueResult(ResultSet resultSet) throws H2ZeroFinderException, SQLException {
		if(resultSet.next()) {
			// we have a result
			Long idField = ConnectionManager.getNullableResultLong(resultSet, 1);
			Long idFieldType = ConnectionManager.getNullableResultLong(resultSet, 2);
			Long idCollection = ConnectionManager.getNullableResultLong(resultSet, 3);
			String nmField = ConnectionManager.getNullableResultString(resultSet, 4);

			Field field = new Field(idField, idFieldType, idCollection, nmField);
	...
	/**
	 * Return the results as a list of Field, this will be empty if
	 * none are found.
	 * 
	 * @param resultSet the results as a list of Field
	 * 
	 * @return the list of results
	 * 
	 * @throws SQLException if there was a problem retrieving the results
	 */
	private static List<Field> list(ResultSet resultSet) throws SQLException {
