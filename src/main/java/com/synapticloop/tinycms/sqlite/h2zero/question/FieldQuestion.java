 ...
 * 
 * <p>Table name: <code>field</code></p>
 * 
 * 
...
public class FieldQuestion {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(FieldQuestion.class);


	// this is an internal SQL question select statement used by the validator
	private static final String SQL_INTERNAL_DOES_PRIMARY_KEY_EXIST = "SELECT (COUNT(*) = 1) WHERE id_field = ?";
	 ...
	 * 
	 * @param idField The primary key for this model
	 * 
	 * @return whether the primary key exists
	 */
	public static boolean internalDoesPrimaryKeyExist(Long idField) {
