 ...
 * 
 * <p>Table name: <code>field_type</code></p>
 * 
 * 
 ...
 */
public class FieldTypeQuestion {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(FieldTypeQuestion.class);


	// this is an internal SQL question select statement used by the validator
	private static final String SQL_INTERNAL_DOES_PRIMARY_KEY_EXIST = "SELECT (COUNT(*) = 1) WHERE id_field_type = ?";



	/** Private to deter instantiation */
	private FieldTypeQuestion() {}

	/**
	 * An internal method to check whether a specific primary key exists, 
	 * generated as part of the validation methods
	 * 
	 * @param idFieldType The primary key for this model
	 * 
	 * @return whether the primary key exists
	 */
	public static boolean internalDoesPrimaryKeyExist(Long idFieldType) {
