...
public class CollectionCounter {
	...
	private static final String BINDER = Constants.COLLECTION_BINDER;
		...
		private static final Logger LOGGER = LoggerFactory.getLogger(CollectionCounter.class);


	private static final String SQL_BUILTIN_COUNT_ALL = "select count(*) from collection";
	...
	/**
	 * Find the count of all Collection objects
	 * 
	 * @param connection the passed in connection object, useful for queries within
	 * a transaction.
	 * 
	 * @return the count of Collection objects
	 * 
	...
	/**
	 * Find the count of all Collection objects and if there is an error
