...
public class DataCollectionDeleter {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DataCollectionDeleter.class);

	// static fields generated by synapticloop h2zero
	private static final String SQL_BUILTIN_DELETE_ALL = "delete from data_collection";
	private static final String SQL_DELETE_START = "delete from data_collection ";
	private static final String SQL_BUILTIN_DELETE_BY_PRIMARY_KEY = SQL_DELETE_START + "where id_data_collection = ?";

	// now for the statement limit cache(s)
	private static final LruCache<String, String> deleteAll_limit_statement_cache = new LruCache<>(1024);

	// We don't allow instantiation
	private DataCollectionDeleter() {}
	...
	/**
	 * Delete a row in the DATA_COLLECTION table by its primary key
	 * 
	 * @param connection The connection to use - the caller must close this connection
	 * @param idDataCollection the primary key to delete
	 * 
	 * @return the number of rows deleted
	 * 
	 * @throws SQLException if there was an error in the delete
	 */
	public static int deleteByPrimaryKey(Connection connection, Long idDataCollection) throws SQLException {
	 ...
	 * @throws SQLException if there was an error in the delete
	 */
	public static int deleteByPrimaryKey(Long idDataCollection) throws SQLException {
		try (Connection connection = ConnectionManager.getConnection()) {
			return(deleteByPrimaryKey(connection, idDataCollection));
		}
	}

	/**
	 * Delete a row in the DATA_COLLECTION table by its primary key silently
	 ...
	 * @return the number of rows deleted
	 */
	public static int deleteByPrimaryKeySilent(Connection connection, Long idDataCollection) {
		try {
			return(deleteByPrimaryKey(connection, idDataCollection));
	 ...
	 */
	public static int deleteByPrimaryKeySilent(Long idDataCollection) {
		try (Connection connection = ConnectionManager.getConnection()) {
			return(deleteByPrimaryKeySilent(connection, idDataCollection));
		} catch (SQLException ex) {
			LOGGER.error("Could not deleteByPrimaryKey, a SQL Exception occurred.", ex);
			return(-1);
		}
	...
	/**
	 * Delete all of the rows in the table 'data_collection'.
	 * 
	...
	/**
	 * Delete all the rows in the DATA_COLLECTION table
	 * 
	 * @return the number of rows deleted
	 * 
	 * @throws SQLException if there was an error in the delete
	...
	/**
	 * Delete all the rows in the DATA_COLLECTION table silently - i.e
	...
	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * 
	 *     USER DEFINED DeleterS FOR THE TABLE: data_collection
	 * 
	 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * 
	 ...
	 * key.
	 * 
	 * There are 0 defined Deleters on the data_collection table:
	 * 
	 * 
	 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
